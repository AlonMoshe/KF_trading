...
class VIXFastDownloader(EWrapper, EClient):
    ...
    def nextValidId(self, orderId):
        ...
        self.reqHistoricalData(
            ...
            contract=contract,
            endDateTime="",
            durationStr="5 D",         # ← FULL YEAR AT ONCE
    ...
    def historicalDataEnd(self, reqId, start, end):
        ...
        df.to_csv(f"C:/Users/User/OneDrive/Projects/TradingSystem/Data/VIX_Data/VIX_2025_12_08_2025-12-12_1min.csv", index=False)
        print("Saved: VIX_2025_12_08_2025-12-12_1min.csv")
        self.disconnect()
